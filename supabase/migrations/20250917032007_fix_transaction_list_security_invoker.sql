-- Fix transaction_list view to respect RLS on underlying transactions table
-- Without security_invoker = on, the view runs with the owner's permissions
-- and bypasses RLS policies. This ensures RLS is enforced for each user query.
